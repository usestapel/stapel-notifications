# Contributing to stapel-notifications
...
```bash
git clone https://github.com/usestapel/stapel-notifications.git && cd stapel-notifications
...
The packages use a flat layout (`package-dir = {{"stapel_notifications": "."}}`), so the
