...
keys, each target language ships as a flat
...
#: not cover. All param-free; edit here + regen when the en changes. Both keys
#: are cross-cutting (verification/network) and also appear in stapel-auth's
#: ru catalog for the same en source text — wording matched verbatim there.
_MACHINE_RU = {
